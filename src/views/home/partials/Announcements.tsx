...
function AnnouncementsCard() {
	return (
		<div className="inline-block px-3">
			<div className="w-64 h-96 max-w-xs overflow-hidden rounded-lg drop-shadow-xl bg-white hover:drop-shadow-2xl transition-shadow duration-300 ease-in-out border-t-4 border-t-blue-800 border-r-4 border-r-yellow-400 px-4 pt-2 py-8 flex flex-col justify-between">
				<div>
