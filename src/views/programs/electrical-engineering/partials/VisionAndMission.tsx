		...
		<div className="bg-white flex flex-row px-24 my-12 gap-2 items-center">
			<div className="flex-1 flex-col text-justify">
				<div>
					...
					<p>
						...
						bidang teknik elektro dalam skala nasional dan internasional.
					</p>
				</div>
				<div className="mt-8">
					...
					<ul className="list-disc">
						<li>
							...
							keahlian di bidang teknik elektro.
						</li>
						<li>
							Mengembangkan ilmu pengetahuan dan keahlian di bidang teknik
							elektro, serta berkontribusi yang relevan dan berkualitas tinggi
							bagi kebutuhan pembangunan nasional, regional, dan internasional.
						</li>
						<li>
						...
						<li>
							Mengembangkan sistem jejaring di bidang teknik elektro dengan
							perguruan tinggi lain khususnya institusi politeknik, masyarakat,
							industri, lembaga pemerintah dan lembaga lain baik tingkat
							nasional maupun internasional dengan azas saling menguntungkan.
						</li>
					</ul>
				</div>
			</div>
			<div className="flex-1">
				<Image
					...
					src="/images/programs/ee/ee-1.png"
					alt="Jumbotron PENS"
					width={1960}
					height={1}
				/>
...
export default EEVisionAndMission;
